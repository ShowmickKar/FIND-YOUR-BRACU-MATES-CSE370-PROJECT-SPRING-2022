...
<head>
    ...
    <link rel="stylesheet" href="https://c...content-available-to-author-only...r.net/npm/bootstrap@4.1.3/dist/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
...
<body>
    ...
    <div>
        <form action="process.php" method="POST">
            ...
            <label for="">ID</label>
            <input type="text" name='id' placeholder="Your ID" value=""><br>
            ...
            <label for="">Current Area</label>
            <input type="text" S name='current_area' placeholder="Current Area" value=""><br>
            <label for="">Hobbies</label>
            <input type="text" S name='hobbies' placeholder="Your Hobbies" value=""><br>
            <label for="">Blood Group</label>
            <input type="text" S name='blood_group' placeholder="Your Blood Group" value=""><br>
            <label for="">Club</label>
            <input type="text" S name='club' placeholder="Your Club" value=""><br>
            <label for="">Date of Birth</label>
            <input type="date" name='birth_date' placeholder="Your Birth Date" value=""><br>
